...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2018 at 09:44 PM
...
(5, 'asdasd', 'asdasd'),
(6, 'Berglunds snabbk??p', 'Christina Berglund'),
(7, 'Blauer See Delikatessen', 'Hanna Moos'),
(8, 'Blondel p??re et fils', 'Fr??d??rique Citeaux'),
(9, 'B??lido Comidas preparadas', 'Mart??n Sommer'),
(10, 'Bon app\'', 'Laurence Lebihan'),
(11, 'Bottom-Dollar Markets', 'Elizabeth Lincoln'),
(12, 'B\'s Beverages', 'Victoria Ashworth'),
(13, 'Cactus Comidas para llevar', 'Patricio Simpson'),
(14, 'Centro comercial Moctezuma', 'Francisco Chang'),
(15, 'Chop-suey Chinesexx', 'Yang Wang'),
(16, 'Com??rcio Mineiro', 'Pedro Afonso'),
(17, 'Consolidated Holdings', 'Elizabeth Brown'),
(18, 'Drachenblut Delikatessen', 'Sven Ottlieb'),
(19, 'Du monde entier', 'Janine Labrune'),
(20, 'Eastern Connection', 'Ann Devon'),
(21, 'Ernst Handel', 'Roland Mendel'),
(22, 'Familia Arquibaldo', 'Aria Cruz'),
(23, 'FISSA Fabrica Inter. Salchichas S.A.', 'Diego Roel'),
(24, 'Folies gourmandes', 'Martine Ranc??'),
(25, 'Folk och f?? HB', 'Maria Larsson'),
(26, 'Frankenversand', 'Peter Franken'),
(27, 'France restauration', 'Carine Schmitt'),
(28, 'Franchi S.p.A.', 'Paolo Accorti'),
(29, 'Furia Bacalhau e Frutos do Mar', 'Lino Rodriguez '),
(30, 'Galer??a del gastr??nomo', 'Eduardo Saavedra'),
(31, 'Godos Cocina T??pica', 'Jos?? Pedro Freyre'),
(32, 'Gourmet Lanchonetes', 'Andr?? Fonseca'),
(33, 'Great Lakes Food Market', 'Howard Snyder'),
(34, 'GROSELLA-Restaurante', 'Manuel Pereira'),
(35, 'Hanari Carnes', 'Mario Pontes'),
(36, 'HILARI??N-Abastos', 'Carlos Hern??ndez'),
(37, 'Hungry Coyote Import Store', 'Yoshi Latimer'),
(38, 'Hungry Owl All-Night Grocers', 'Patricia McKenna'),
(39, 'Island Trading', 'Helen Bennett'),
(40, 'K??niglich Essen', 'Philip Cramer'),
(41, 'La corne d\'abondance', 'Daniel Tonini'),
(42, 'La maison d\'Asie', 'Annette Roulet'),
(43, 'Laughing Bacchus Wine Cellars', 'Yoshi Tannamuri'),
(44, 'Lazy K Kountry Store', 'John Steel'),
(45, 'Lehmanns Marktstand', 'Renate Messner'),
(46, 'Let\'s Stop N Shop', 'Jaime Yorres'),
(47, 'LILA-Supermercado', 'Carlos Gonz??lez'),
(48, 'LINO-Delicateses', 'Felipe Izquierdo'),
(49, 'Lonesome Pine Restaurant', 'Fran Wilson'),
(50, 'Magazzini Alimentari Riuniti', 'Giovanni Rovelli'),
(51, 'Maison Dewey', 'Catherine Dewey'),
(52, 'M??re Paillarde', 'Jean Fresni??re'),
(53, 'Morgenstern Gesundkost', 'Alexander Feuer'),
(54, 'North/South', 'Simon Crowther'),
(55, 'Oc??ano Atl??ntico Ltda.', 'Yvonne Moncada'),
(56, 'Old World Delicatessen', 'Rene Phillips'),
(57, 'Ottilies K??seladen', 'Henriette Pfalzheim'),
(58, 'Paris sp??cialit??s', 'Marie Bertrand'),
(59, 'Pericles Comidas cl??sicas', 'Guillermo Fern??ndez'),
(60, 'Piccolo und mehr', 'Georg Pipps'),
(61, 'Princesa Isabel Vinhos', 'Isabel de Castro'),
(62, 'Que Del??cia', 'Bernardo Batista'),
(63, 'Queen Cozinha', 'L??cia Carvalho'),
(64, 'QUICK-Stop', 'Horst Kloss'),
(65, 'Rancho grande', 'Sergio Guti??rrez'),
(66, 'Rattlesnake Canyon Grocery', 'Paula Wilson'),
(67, 'Reggiani Caseifici', 'Maurizio Moroni'),
(68, 'Ricardo Adocicados', 'Janete Limeira'),
(69, 'Richter Supermarkt', 'Michael Holz'),
(70, 'Romero y tomillo', 'Alejandra Camino'),
(71, 'Sant?? Gourmet', 'Jonas Bergulfsen'),
(72, 'Save-a-lot Markets', 'Jose Pavarotti'),
(73, 'Seven Seas Imports', 'Hari Kumar'),
(74, 'Simons bistro', 'Jytte Petersen'),
(75, 'Split Rail Beer & Ale', 'Art Braunschweiger'),
(76, 'Supr??mes d??lices', 'Pascale Cartrain'),
(77, 'The Big Cheese', 'Liz Nixon'),
(78, 'The Cracker Box', 'Liu Wong'),
(79, 'Toms Spezialit??ten', 'Karin Josephs'),
(80, 'Tortuga Restaurante', 'Miguel Angel Paolino'),
(81, 'Tradi????o Hipermercados', 'Anabela Domingues'),
...
(86, 'Die Wandernde Kuh', 'Rita M??ller'),
...
(1, 'ppppppp', 1, 1, 'pppp', 1, 1, '1'),
(2, 'ppppp', 1, 1, '2222- 12 oz bottles', 111, 111, '1'),
...
(9, 'PB Kn??ckebr??d AB', 'Lars Peterson'),
(10, 'Refrescos Americanas LTDA', 'Carlos Diaz'),
(11, 'Heli S????waren GmbH & Co. KG', 'Petra Winkler'),
(12, 'Plutzer Lebensmittelgro??m??rkte AG', 'Martin Bein'),
...
(17, 'Svensk Sj??f??da AB', 'Michael Bj??rn'),
(18, 'Aux joyeux eccl??siastiques', 'Guyl??ne Nodier'),
...
(28, 'Gai p??turage', 'Eliane Noz'),
(29, 'For??ts d\'??rables', 'Chantal Goulet');
...
--
ALTER TABLE `customers`
  MODIFY `CustomerID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
COMMIT;
